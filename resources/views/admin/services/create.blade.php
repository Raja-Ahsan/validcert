...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="fas fa-plus"></i> Create New Service</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon') }}" placeholder="e.g., fas fa-cog">
...
<script>
    ...
    // Load existing form fields if editing
    @if(old('form_fields'))
        const existingFields = @json(old('form_fields'));
